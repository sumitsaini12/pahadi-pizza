      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          <div className="flex gap-8 min-w-max">
            {REVIEWS.map((review) => (
              <div key={review.id} className="flex-shrink-0 w-[320px] md:w-[380px] bg-white p-10 rounded-[32px] shadow-sm border border-gray-100 relative group hover:shadow-xl transition-all">
